            ...
            <div class="py-8">
                ...
                <div class="my-2 flex sm:flex-row flex-col">
                    <div class="flex flex-row mb-1 sm:mb-0">
                        <form action="{{ route('artisan.deliveries') }}" method="GET">
                            <div class="relative">
                                <select name="date"
                                            ...
                                            <div class="flex items-center">
                                                <div class="flex-shrink-0 w-10 h-10">
                                                    <img class="w-full h-full rounded-full border"
                                                        src="{{ $delivery->deliveryMan->user->image ? (str_starts_with($delivery->deliveryMan->user->image, 'http') ? $delivery->deliveryMan->user->image : asset('storage/' . $delivery->deliveryMan->user->image)) : asset('assets/user.png') }}" />
                                                </div>
                                                <div class="ml-3">
                                                    <p class="text-gray-900 whitespace-no-wrap">
                                                        {{ $delivery->deliveryMan->user->getFullName() }}
                                                    </p>
                                                </div>
                                            </div>
                                        </td>
