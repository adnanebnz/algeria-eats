    ...
    <div class="mx-auto max-w-7xl pb-16 sm:px-6 lg:px-8">
        <div
            ...
            <div class="mx-auto max-w-md text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left">
                <h2 class="text-3xl font-bold tracking-tight text-gray-800 sm:text-4xl">Optimisez l'efficacité de votre
                    entreprise<br>Utilisez notre application .</h2>
            ...
            <div class="relative mt-16 h-80 lg:mt-8">
                <img class="absolute left-0 top-0 w-[57rem] max-w-none rounded-md bg-white/5 ring-1 ring-white/10"
                    src="{{ asset('assets/pic.png') }}" alt="App screenshot" width="1824" height="1080">
            </div>
        </div>
    </div>
</div>
